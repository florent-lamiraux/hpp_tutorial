...
Having installed HPP as started a docker container by following the steps described in [tutorial 1](../tutorial_1/README.md)
...
Let us have a quick look at the code in `script.py`.
```
robot = Device("tuto")
```
